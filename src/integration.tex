...
This chapter describes how the synchronization prototype was integrated with a companion-computer environment using UART communication and ROS2. 
The purpose of this integration was to collect synchronization diagnostics, publish received data to ROS2 topics, and store measurements for later analysis. The ROS2 pipeline was used for firmware-level and communication-level evaluation, while the later physical PPS-to-GPIO synchronization accuracy measurement was performed separately using a logic analyzer.
...
This distinction is also important for the physical synchronization measurement. ROS2 arrival timestamps describe communication latency and logging behavior, whereas the PPS-to-GPIO measurement captures the local embedded response delay between the external PPS edge and the STM32-generated synchronization output.
...
\begin{itemize}
    ...
    \item separation of ROS2-based diagnostic logging from the later logic-analyzer-based physical synchronization measurement.
\end{itemize}
