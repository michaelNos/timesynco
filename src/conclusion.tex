...
\begin{itemize} \item successful DCF77 time decoding and validation, \item software RTC implementation on STM32, \item external PPS-based clock discipline, \item ROS2-based timing comparison infrastructure, \item hardware-level synchronization validation, \item stable long-term synchronized operation. \end{itemize}
