...
Doplňkové měření pomocí logického analyzátoru, které porovnávalo RTK PPS vstup se synchronizačním GPIO výstupem mikrokontroléru STM32, ukázalo typickou submilisekundovou fyzickou odezvu při běžném provozu. Občasné latenční špičky zároveň potvrdily, že praktická přesnost je omezena především latencí EXTI přerušení, režií HAL knihovny a zpožděním přepnutí GPIO výstupu.
