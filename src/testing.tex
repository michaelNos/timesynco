...
\begin{verbatim} HAL_GPIO_TogglePin(TEST_GPIO_Port, TEST_Pin); clock_add_one_second(); \end{verbatim}
...
\noindend Figure~\ref{fig:physical_offset_histogram} presents the statistical distribution of the measured synchronization offsets.
...
\begin{itemize}
    \item Average PPS → GPIO offset: 50–300 µs
    \item Jitter: ±20–100 µs
    \item Occasional spikes: 0.5–2 ms
    \item Worst case: 11 ms
\end{itemize}
